[![Build Status](https://app.travis-ci.com/Zhou-Yicheng/travis-ci-tutorial-java.svg?branch=master)](https://app.travis-ci.com/Zhou-Yicheng/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/Zhou-Yicheng/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/Zhou-Yicheng/travis-ci-tutorial-java)
...
3. Fix the `README.md` badges (replacing in the URL `joaomlneto` with `your-github-name`) and push the changes. This should trigger a build in Travis CI!
